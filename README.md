...
Початковий стан: перший слайд та індикатор мають клас active.
Кнопки перемикання працюють правильно.
Циклічне перемикання працює в обох напрямках.
Керування клавіатурою працює для всіх вказаних клавіш.
Свайпи працюють на desktop та mobile пристроях.
Автоматичне перемикання працює з правильним інтервалом.
Кнопка пауза/відтворення коректно змінює стан та іконку.
Кліки на індикатори переключають на відповідний слайд.
